...
public class Animador extends JFrame {    
    ...
    public Animador() {
        ...
        txfEntradaArranjo = new JTextField("9,8,7,6", COMPRIMENTO_ENTRADA_ARRANJO);
    ...
    public void onBtnCarregarPressionado() {
        ...
        switch (algoritmo) {
            ...
            case "Bolha":
                novoFilme = AlgoritmosAnimados.ordenarPorBolha(arranjo);
                break;
            ...
            case "Inserção":
                novoFilme = AlgoritmosAnimados.ordenarPorInsercao(arranjo);
                break; 
                
            case "Mergesort":   
                novoFilme = AlgoritmosAnimados.ordenarPorMergesort(arranjo);
                break; 
                
            case "Quicksort":
                novoFilme = AlgoritmosAnimados.ordenarPorQuicksort(arranjo);
                break; 
